...
@implementation ComMfoggSquarecameraModule
...
-(id)moduleGUID
{
	return @"af2428c0-0bcf-4757-9838-3bbd7c558dd0";
}
...
MAKE_SYSTEM_PROP(QUALITY_UHD, UHD_QUALITY);
MAKE_SYSTEM_PROP(QUALITY_PHOTO, PHOTO_QUALITY);
